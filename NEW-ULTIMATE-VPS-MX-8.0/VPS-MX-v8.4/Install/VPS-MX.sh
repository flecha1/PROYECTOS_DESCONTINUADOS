...
function_verify () {
wget -O /usr/bin/trans https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/ArchivosUtilitarios/trans &> /dev/null
wget -O /etc/versin_script https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/Version &> /dev/null
wget -O /usr/bin/SPR https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/SPR/SPR &> /dev/null
chmod +x /usr/bin/SPR
## lognull
...
[[ $(find /etc/VPS-MX/controlador -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/VPS-MX/controlador/nombre.log https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/ArchivosUtilitarios/nombre.log &>/dev/null
...
wget https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Modulos/message1.txt &> mv /etc/VPS-MX/message1.txt
...
wget -O /etc/versin_script_new https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/Version &>/dev/null
wget -O /etc/versin_script https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/Version &>/dev/null
msg -bar2
...
echo 'echo "" '>> .bashrc
echo 'mess1="$(less /etc/VPS-MX/message1.txt)" ' >> .bashrc
echo 'echo "" '>> .bashrc
echo 'echo -e "\t\033[92mRESELLER : $mess1 "'>> .bashrc
echo 'echo "" '>> .bashrc                                               
echo 'echo -e "\t\033[97mPARA MOSTAR PANEL BASH ESCRIBA: sudo VPS-MX o vps-mx "'>> .bashrc
echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/Version &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
...
case $1 in
"menu"|"message1.txt")ARQ="${SCPdir}/";; #Menu
...
fun_ip
wget -O /usr/bin/trans https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/ArchivosUtilitarios/trans &> /dev/null
wget -O /bin/Desbloqueo.sh https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/ArchivosUtilitarios/Desbloqueo.sh &> /dev/null
chmod +x /bin/Desbloqueo.sh
wget -O /bin/monitor.sh https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/Monitor-Service/monitor.sh &> /dev/null
chmod +x /bin/monitor.sh
wget -O /var/www/html/estilos.css https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/Monitor-Service/estilos.css &> /dev/null
msg -bar2
msg -bar2
msg -ama "     [ VPS - MX - SCRIPT \033[1;97m ❌ MOD By @flechaverde ❌\033[1;33m ]"
