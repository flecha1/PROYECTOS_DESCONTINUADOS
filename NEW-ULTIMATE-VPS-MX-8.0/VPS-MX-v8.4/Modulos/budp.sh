...
msg -tit
    ...
    wget -O /bin/badvpn-udpgw https://raw.githubusercontent.com/flecha1/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.4/Install/ArchivosUtilitarios/badvpn-udpgw &>/dev/null
