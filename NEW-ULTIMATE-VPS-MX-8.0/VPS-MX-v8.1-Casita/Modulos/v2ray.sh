...
source <(curl -sL https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.1-Casita/Install/V2RAY/install.sh)
...
unistallv2 () {
source <(curl -sL https://raw.githubusercontent.com/flecha1/remods/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.1-Casita/Install/V2RAY/install.sh) --remove
}
infocuenta () {
v2ray info
}
